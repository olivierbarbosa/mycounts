      ...
      <form className={styles.feuille} onSubmit={enregistrer} noValidate>
        ...
        <div className={styles.faits}>
          <span className={styles.fait}>
            <span className={styles.cle}>Date</span>
            <span className={styles.valeur}>
              {DATE_LONGUE.format(dateCivile(operation.date_operation))}
            </span>
          </span>
          <span className={styles.fait}>
        ...
        <div className={styles.champ}>
          ...
          <p className={styles.note}>
            Le compte ne se change pas ici : déplacer une opération modifierait le solde de
            deux comptes. Supprimez et ressaisissez.
          </p>
        </div>
