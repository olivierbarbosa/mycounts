...
export const couleursSombres = {
  ...
  degradeAccent:
    "linear-gradient(180deg, #8C56D4 0%, #7F4CC4 55%, #6C3FAA 100%)",
  degradeAccentSurvol:
    "linear-gradient(180deg, #9560DE 0%, #8752CE 55%, #7345B4 100%)",
...
export const couleursClaires = {
  ...
  degradeAccent:
    "linear-gradient(180deg, #7B47BE 0%, #6E3DAE 55%, #5D3193 100%)",
  degradeAccentSurvol:
    "linear-gradient(180deg, #8951CC 0%, #7B47BE 55%, #6A3AA6 100%)",
...
const enKebab = (nom: string): string =>
  nom.replace(/[A-Z]/g, (l) => `-${l.toLowerCase()}`);
